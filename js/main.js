document.addEventListener('DOMContentLoaded', function () {
  ...
  var T = {
    en: {
      ...
      priceLine: '🌾 xx € - Ticket including drinks and music, price TBA',
      campingLine: '🦉 Camping on site - bring your tent (or a few airbnb around but be quick!)',
      nameLabel: 'Your name and last name:',
    ...
    fr: {
     ...
     stationText: 'Ychoux',
     stationHref: 'https://www.sncf-connect.com/train/france/nouvelle-aquitaine/ychoux',
      priceLine: '🌾 xx € - Ticket incluant drinks et music, prix annoncé très prochainement',
      campingLine: '🦉 Dodo au camping sur place - apporte ta tente (ou quelques airbnb/location dans le coin mais réservez vite)',
      nameLabel: 'Ton nom et prénom:',
